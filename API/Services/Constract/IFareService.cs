...
namespace API.Services.Constract
{
    ...
    {
        Task<FeeViewModel> CaculateFeeByDistance(int vehicleTypeId, double distance, TimeOnly time, bool includeBasePrice = true);
        ...
        Task<FeeViewModel> CaculateFeePerTrip(int vehicleTypeId, DateOnly startDate, DateOnly endDate, List<DayOfWeek> dayOfWeeks, double distance, TimeOnly time);
    }
}
