...
namespace API.Services.Constract
{
    ...
    {
        Task<FeeViewModel> CaculateFeeByDistance(VehicleTypes.SpecificType vehicleTypeId, double distance, TimeOnly time, bool includeBasePrice = true, bool roundToThousands = true);
