...
namespace API.Services.Constract
{
    public interface IRapidApiService
    {
        ...
        Task<Domain.Entities.Route?> CreateRouteByListOfStation(List<StationDTO> stations, int? userId = null, string? routeName = null);
        Task<Response> CreateRoute(int adminId, CreateRouteRequest request, Response success, Response failed);
