...
namespace API.Services.Constract
{
    public interface IPromotionService
    {
        ...
        Task<Promotion?> GetPromotionByCode(string code, int userId, double totalPrice, int totalTickets, PaymentMethods paymentMethods, VehicleTypes.Type vehicleType);
    }
}
