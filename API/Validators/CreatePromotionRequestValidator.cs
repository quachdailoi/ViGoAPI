...
{
    public class CreatePromotionRequestValidator : BaseAbstractValidator<CreatePromotionRequest>
    {
        public CreatePromotionRequestValidator(IAppServices appServices)
        {
